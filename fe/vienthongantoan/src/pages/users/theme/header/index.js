...
export const categories = [
  ...
  "Nhà thông minh",
  "Tivi màn hình Led",
  "Định vị [GPS] Ô Tô - Xe Máy",
  "Báo Trộm - Báo Cháy",
  "Phụ Kiện Điện Tử Viễn Thông",
  "Truyền hình vệ tinh Satellite",
          ...
          <div className="row">
            <div className="col-6 header__top_left">
              <ul>
                ...
                <li>
                  <AiOutlineTruck />
                  Miễn ship đơn trên {formatter(2000000)}
                </li>
              </ul>
            </div>
              ...
              <div className="hero__search__form">
                <form>
                  <input
                    ...
                    name=""
                    value=""
                    placeholder="Gõ sản phẩm cần tìm vào đây"
                  />
